...
ActiveRecord::Schema.define(version: 2021_02_02_180744) do
  ...
  create_table "users", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "notifications_token", null: false
    t.integer "account_type", default: 0, null: false
    t.integer "role", default: 0, null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.boolean "permit_push_notifications", default: true, null: false
    t.boolean "permit_mail_notifications", default: true, null: false
  ...
  create_table "watched_books", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["user_id", "book_id"], name: "index_watched_books_on_user_id_and_book_id", unique: true
